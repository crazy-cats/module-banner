...
{
    public const BOOKMARK_KEY = 'banner_group';
            ...
            [
                ...
                'actions' => [
                    [
                        'name'   => 'redirect',
                        'label'  => __('Banners'),
                        'url'    => $this->getUrl('banner/banner/index'),
                        'params' => ['mid' => ':id']
                    ],
                    [
                        'name'  => 'edit',
                        'label' => __('Edit'),
                        'url'   => $this->getUrl('banner/group/edit')
                    ],
                    [
                        'name'    => 'delete',
                        'label'   => __('Delete'),
                        'confirm' => __('Sure you want to remove this item?'),
                        'url'     => $this->getUrl('banner/group/delete')
                    ]
                ]
            ]
        ];
    ...
    {
        return $this->getUrl('banner/group/grid');
    }
}
